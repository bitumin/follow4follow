...
var AuthComponent = /** @class */ (function () {
    function AuthComponent(activatedRoute, http) {
        var _this = this;
        this.activatedRoute = activatedRoute;
        this.http = http;
        this.token = '-';
        this.usersEndpoint = 'https://api.instagram.com/v1/users/';
        this.myUserId = 'morianami';
        this.activatedRoute.fragment.subscribe(function (fragment) {
            _this.token = fragment.substring(fragment.indexOf('#access-token=') + 1);
            _this.fetchFollowers(_this.token);
        });
    }
    AuthComponent.prototype.ngOnInit = function () {
    };
    AuthComponent.prototype.fetchFollowers = function (token) {
        var _this = this;
        return this.http
            .get(this.usersEndpoint + this.myUserId + '/follows?access_token=' + token)
            .subscribe(function (data) { return _this.myFollowers = data; });
    };
...
module.exports = "<div style=\"text-align:center\">\n  <h2>Start</h2>\n  <a target=\"_blank\" rel=\"noopener\" [href]=\"loginUrl\">\n    Login to Instagram\n  </a>\n</div>\n"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent() {
        this.clientId = 'baa91da9644047d589493259b0aa7119';
        this.redirectUri = 'http://mitxelmoriana.com/follow4follow/auth';
        this.loginUrl = 'https://api.instagram.com/oauth/authorize/' +
...
module.exports = __webpack_require__(/*! /Users/tresipunt/Development/follow4follow/src/main.ts */"./src/main.ts");
